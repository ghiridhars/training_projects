		...
		$("#submit")
				.on(
						...
						function() {
							...
							$.ajax({
										type : 'GET',
										url : '/student/getStudentByGender/'
												+ className + '/' + gender,
										result : {},
										dataType : 'json',
...
<body>
	...
	<div class="container">
		...
		<div class="form-group">
			<label>Male</label> <input type="radio" value="male" id="gender"
				name="gender"></input>
		</div>
		<div class="form-group">
			<label>Female</label> <input type="radio" value="female" id="gender"
				name="gender" />
		</div>
		<div class="form-group">
			<label>Others</label> <input type="radio" value="others" id="gender"
				name="gender"></input>
		</div>
