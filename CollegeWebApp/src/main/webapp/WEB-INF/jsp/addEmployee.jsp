...
<body>
	<div class="container">
		...
		<form method="post" action="showEmployee" modelAttribute="employee">
			...
			<div class="form-check" name="checkHobby" id="checkHobby">
				<input class="form-check-input" type="checkbox" name="hobbies"
					value="read" id="read_check" onclick="validateCheck()"> <label
					class="form-check-label" for="read_check"> Read</label> <input
					class="form-check-input" type="checkbox" name="hobbies"
					value="cycle" id="cycle_check" onclick="validateCheck()"> <label
					class="form-check-label" for="cycle_check">Cycle</label> <input
					class="form-check-input" type="checkbox" name="hobbies"
					value="dance" id="dance_check" onclick="validateCheck()"> <label
					class="form-check-label" for="dance_check"> Dance</label> <input
					class="form-check-input" type="checkbox" name="hobbies"
					value="sing" id="sing_check" onclick="validateCheck()"> <label
